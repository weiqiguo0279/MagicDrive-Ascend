...
os.environ['SSL_CERT_FILE'] = '/home/ma-user/anaconda3/envs/magic_drive/ssl/cacert.pem'
import gradio as gr
...
def load_model_from(
        dir, weight_dtype=torch.float16, device="npu", with_xformers=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="pretrained/MagicDrive-272x736-400ep")
    parser.add_argument(
