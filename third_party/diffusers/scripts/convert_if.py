...
def superres_check_against_original(dump_path, unet_checkpoint_path):
    ...
    if "-II-" in orig_path:
        ...
        if_II_model = IFStageII(device="npu", dir_or_name=orig_path, model_kwargs={"precision": "fp32"}).model
    elif "-III-" in orig_path:
        from deepfloyd_if.modules import IFStageIII

        if_II_model = IFStageIII(device="npu", dir_or_name=orig_path, model_kwargs={"precision": "fp32"}).model
