...
class Attention(nn.Module):
    ...
    def set_use_memory_efficient_attention_xformers(
        ...
        if use_memory_efficient_attention_xformers:
            ...
            elif not torch_npu.npu.is_available():
                raise ValueError(
                    "torch_npu.npu.is_available() should be True but is False. xformers' memory efficient attention is"
