...
if is_torch_available():
    ...
    if "DIFFUSERS_TEST_DEVICE" in os.environ:
        ...
        available_backends = ["npu", "cpu", "mps"]
        ...
        torch_device = "npu" if torch_npu.npu.is_available() else "cpu"
...
def require_torch_gpu(test_case):
    ...
    return unittest.skipUnless(is_torch_available() and torch_device == "npu", "test requires PyTorch+CUDA")(
        test_case
    )
