...
_triton_is_available = torch_npu.npu.is_available()
        ...
        try:
            for benchmark_object in benchmarks_generator:
                ...
                try:
                    ...
                    mem_begin = torch_npu.npu.max_memory_allocated() / 2**20
                    benchmark_object._task_spec = replace(
                    ...
                    memory = torch_npu.npu.max_memory_allocated() / 2**20 - mem_begin
