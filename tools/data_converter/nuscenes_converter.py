...
import sys
import os
sys.path.append(os.path.abspath('/home/ma-user/work/MagicDrive'))

from mmhelpers.box_np_ops import points_cam2img
from mmhelpers.datasets.nuscenes_dataset import NuScenesDataset
